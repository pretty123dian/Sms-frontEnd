<template>
  <div class="mb-10 bg-white mt-5">
    <form @submit.prevent="postInstructor()">
      <div class="mb-10">
            ...
            <div class="center">
              <div class="size-example grid grid-cols-5 gap-5">
                ...
                <div class="col-span-5 lg:col-span-1 md:col-span-5">
                  ...
                  <input
                    type="text"
                    v-model="instrData[i].othernames"
                ...
                <div class="col-span-5 lg:col-span-1 md:col-span-5">
                  ...
                  <input
                    type="text"
                    v-model="instrData[i].phone"
                    :placeholder="i != 0 ? 'Phone number' : ''"
                    :key="i"
                    class="form-input p-2 mt-2 mr-4 border border-#E1E1E1-600 rounded-sm"
                    maxlength="10"
                    minlength="10"
                 ...
                 <div class="col-span-5 lg:col-span-1 md:col-span-5">
                  ...
                  <input
                    type="text"
                    v-model="instrData[i].national_id"
                    :placeholder="i != 0 ? 'National ID' : ''"
                    :key="i"
                    class="form-input p-2 mt-2 mr-4 border border-#E1E1E1-600 rounded-sm"
                    maxlength="16"
                    minlength="16"
...
ClipLoader
  ...
  beforeMount() {
    this.instrData.push(this.getUserdata());
  },
  methods: {
    setGender(index, gender) {
      this.instrData[index].gender = gender;
    },

    getUserdata() {
      const fields = {
        category: "5fc7bf13166c8224c866ea36"
      };
      return fields;
    },
    ...
    async postInstructor() {
      ...
      const response = await Services.addUser({ users: this.instrData });
