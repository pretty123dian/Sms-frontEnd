  ...
  <div
    :class="[
      this.$route.name != 'Dashboard'
        ? 'p-2 pl-4 search-bar relative'
        : 'p-2 pl-4 search-bar relative search_bar_dashboard',
    ]"
  >
    <div class="grid grid-cols-2 gap-4 flex items-center">
        ...
        <form method="">
          <div class="relative text-gray-600 focus-within:text-gray-400">
            ...
            <input
              type="search"
              name="q"
              class="w-full search-box py-2 text-sm text-white bg-white-900 rounded-full pl-10 focus:outline-none focus:text-gray-900"
      ...
      <div class="col-start-6 col-end-12 top-0">
        <div class="">
          <vs-button
            color="#574AE2"
            class="focus:outline-none w-1/2"
            @click="setDropdown"
          >
            {{ drop_icon }}
          </vs-button>
        ...
        <div
          ...
          class="card bg-white p-2 lg:w-1/3 md:w-full rounded search__preview_more shadow"
        >
